...
public class IntroActivity extends AppIntro {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        addSlide(AppIntroFragment.newInstance("Keep your own Wish List", "Create your own wishlist, " +
                        "fill it with all your wisher, and let your friends know what you wish.",
        ...
        addSlide(AppIntroFragment.newInstance("Add images", "You can choose image for you wish from your phone or use image search",
